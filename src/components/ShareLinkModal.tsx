  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#14181F]/70 backdrop-blur-xs">
      <div className="bg-[#1B2A4A] text-[#F6F2E9] w-full max-w-md border-2 border-[#B8924A] p-6 corner-bracket shadow-2xl">
        ...
        <div className="my-5 p-4 bg-[#F6F2E9] border border-[#B8924A] text-center flex flex-col items-center">
          <div className="p-3 bg-[#F6F2E9] border border-[#1B2A4A] mb-2">
          ...
          <span className="font-serif font-bold text-sm text-[#14181F]">Scan Passport QR</span>
          <span className="text-[11px] font-mono text-[#14181F]/70">Verified Once · Trusted Everywhere</span>
        </div>
